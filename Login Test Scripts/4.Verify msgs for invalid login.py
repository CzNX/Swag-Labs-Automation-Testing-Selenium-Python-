...
# test case --> Verify the messages for invalid login.

# test data --> standard_user234 (invalid) , secret_sauce124 (invalid)
...
if (driver.current_url != home_url):
    if (erromsg_element.is_displayed()):

        print("Login Failed!, " + str(erromsg_element.text)+" ")
else:
    print('Login Passed!')
