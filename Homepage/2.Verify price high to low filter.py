...
# test case --> Verify high to low price sorting.
...
selector.select_by_visible_text('Price (high to low)')
...
default_highest_price = default_prices[0]
default_prices.sort(reverse=True)
# highest price in all store
highest_price_item = default_prices[0]

# print(sorted_prices)
# verification

if (default_highest_price == highest_price_item):
    print('High to low sorting is working fine')
else:
    print('High to low sorting isnt working properly')
